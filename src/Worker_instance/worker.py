...
# Detect the results without output
        """
        Args:
            image: camera image
...
# Examine the detected results and select the desired output
        self.car_boxes = []
...
# As title - output the results as string, to be sent as ZeroMQ message
...
# Initialize the SSD detector to save time.
...
# Draw the detected box onto the image to save the time on the front end.
